    ...
    <div class="container-fluid page-header" style="background-color: green">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">Comunicados del Alumno</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="inicio.php">Inicio</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">C.Alumnos</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <?php 
                           ...
                           $comunicadosA = "SELECT * FROM comunicados JOIN usuario ON comunicados.id_alumno = usuario.dni WHERE usuario.dni = $dni";
                           $ComunicadoA = $objConexion->consultar($comunicadosA);
       
                           foreach ($ComunicadoA as $comunicadosA){ 
                            ...
                            if ($contador < $startIndex) {
                                ...
                                $imagenRuta = 'imagenes/';
                                $imagen = $imagenRuta . $comunicadosA['imagenC'];
                                ?> 
                    
                        <div class="col-md-6 mb-4 pb-2">

                            <form action="comunicadosA.php" enctype = "multipart/form-data" method="post">
                            <div class="blog-item">
                                
                                <div class="position-relative">
                                    <img class="img-fluid w-65" src="<?php echo $imagen;?>" alt="">
                                    <div class="blog-date">
                                        <small class="mb-n3 font-weight-bold"><?php echo $comunicadosA['fecha'] ?></small>
                                    </div>
                                </div>
                                <div class="bg-white p-4">
                                    <div class="d-flex mb-2">
                                        ...
                                        <a class="text-primary text-uppercase text-decoration-none" href="mostrarComunicado.php?id=<?php echo urlencode($comunicadosA['codigo']);?>"><?php echo $comunicadosA['titulo'];?></a>
                                    </div>
                                    <a class="h5 m-0 text-decoration-none" href="mostrarComunicado.php?id=<?php echo urlencode ($comunicadosA['codigo']);?>"><?php 
                                    
                                    $descripcion = $comunicadosA['comunicado'];
                    ...
                    $sqlTotalComunicados = "SELECT COUNT(*) AS total FROM comunicados WHERE id_alumno = $dni";
                        ...
                        <div class="col-12">
                            <nav aria-label="Page navigation">
                                <ul class="pagination pagination-lg justify-content-center bg-white mb-0" style="padding: 30px;">
                                  <li class="page-item ">
                                    <a class="page-link" href="comunicadosA.php?pag=<?php echo($pag -1)?>" aria-label="Previous">
                                  ...
                                  <?php
                                  if ($pag > 1) {
                                        echo "<li class='page-item' ><a class='page-link' href='comunicadosA.php?pag=" . ($pag - 1) . "'>" . ($pag - 1) . "</a></li>";
                                    }   

                                    echo "<li class='page-item active'><a class='page-link' href='comunicadosA.php?pag=" . ($pag). "'>".$pag."</a></li>";
                                    if ($pag < $totalPaginas) {
                                    echo "<li class='page-item '><a class='page-link' href='comunicadosA.php?pag=" . ($pag + 1). "'>".($pag +1)."</a></li>";
                                    }
                                    if ($pag +1 < $totalPaginas) {
                                        echo "<li class='page-item'><a class='page-link' href='comunicadosA.php?pag=" . ($totalPaginas) . "'>" . ($totalPaginas) . "</a></li>";
                                    }
                                    ?>
                                  <li class="page-item" >
                                    <a class="page-link" href="comunicadosA.php?pag=<?php echo($pag +1)?>" aria-label="Next">
