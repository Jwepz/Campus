...
if ($usuario = $_SESSION['correo']){
    ...
    if($tipo == "p"){
        ...
        if($_POST){
            ...
            $profesor = "SELECT id_curso FROM profesores WHERE id_profesor = $dni";
            $Profesor = $objConexion->consultar($profesor);
        ...
        $objConexion = new Conexion();
        $sql = "INSERT INTO `trabajos` (`proyecto`,`descripcion`, `archivo`, `id_curso`, `id_profesor`) VALUES ('$nombre','$descripcion', '$imagen', '$curso', '$dni')";
        $objConexion->ejecutar($sql); 
        header("location:tareasP.php");
            }
            }
        }
...
<body>
    ...
    <div class="container-fluid position-relative nav-bar p-0">
        <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                <a href="inicioP.php" class="navbar-brand">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <?php 
                        ...
                        $trabajos = "SELECT * FROM trabajos WHERE id_profesor = '".$dni."';";
                           ...
                           <form action="tareasP.php" enctype = "multipart/form-data" method="post">
                           <div class="blog-item">
                               
                               <div class="position-relative">
                                   <img class="img-fluid w-65" src="<?php echo $imagen;?>" alt="">
                                   <div class="blog-date">
                                       <small class="mb-n3 font-weight-bold"> Fecha: <?php echo $trabajos['fecha'] ?></small>
                                       <small class="mb-n3 font-weight-bold"> Curso: <?php echo $trabajos['id_curso'] ?></small>
                                   </div>
                               </div>
                               <div class="bg-white p-4">
                                   <div class="d-flex mb-2">
                                       ...
                                       <a class="text-primary text-uppercase text-decoration-none" href="mostrarTareaP.php?id=<?php echo urlencode($trabajos['id']);?>"><?php echo $trabajos['proyecto'];?></a>
                                   </div>
                                   <a class="h5 m-0 text-decoration-none"  href="mostrarTareaP.php?id=<?php echo urlencode ($trabajos['id']);?>"><?php 
                    ...
                    $sqlTotalComunicados = "SELECT COUNT(*) AS total FROM trabajos WHERE id_profesor = $dni";
                       ...
                       <div class="col-12">
                            <nav aria-label="Page navigation">
                                <ul class="pagination pagination-lg justify-content-center bg-white mb-0" style="padding: 30px;">
                                  <li class="page-item ">
                                    <a class="page-link" href="tareasP.php?pag=<?php echo($pag -1)?>" aria-label="Previous">
                                  ...
                                  <?php
                                  if ($pag > 1) {
                                        echo "<li class='page-item' ><a class='page-link' href='tareasP.php?pag=" . ($pag - 1) . "'>" . ($pag - 1) . "</a></li>";
                                    }  
                                    
                                    echo "<li class='page-item active'><a class='page-link' href='tareasP.php?pag=" . ($pag). "'>".$pag."</a></li>";
                                    if ($pag < $totalPaginas) {
                                    echo "<li class='page-item '><a class='page-link' href='tareasP.php?pag=" . ($pag + 1). "'>".($pag +1)."</a></li>";
                                    }
                                    if ($pag +1 < $totalPaginas) {
                                        echo "<li class='page-item'><a class='page-link' href='tareasP.php?pag=" . ($totalPaginas) . "'>" . ($totalPaginas) . "</a></li>";
                                    }
                                    ?>
                                  <li class="page-item" >
                                    <a class="page-link" href="tareasP.php?pag=<?php echo($pag +1)?>" aria-label="Next">
    ...
    <div class="card-body">
    <form action="tareasP.php" method="post" enctype = "multipart/form-data">

        Nombre del Trabajo: <input required class="form-control" type="text" name="proyecto">
    ...
    <br>
        Curso: <input class="form-control" type="text" name="curso">
        
    <br>
        Fecha: <input class="form-control" type="date" method="post" name="fecha">
        
    <br>
    <input class="btn btn-success"  type="submit" value="enviar tarea">
