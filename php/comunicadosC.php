    ...
    <div class="container-fluid page-header" style="background-color: green">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">Comunicados Del Curso</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="inicio.php">Inicio</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">C.    Curso</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <?php 
                        ...
                        $comunicadosC = "SELECT * FROM comunicados JOIN usuario ON comunicados.id_curso = usuario.id_curso WHERE usuario.dni = '".$dni."';";
                    ...
                    $sqlTotalComunicados = "SELECT COUNT(*) AS total FROM comunicados WHERE id_curso = $curso";
                       ...
                       <div class="col-12">
                            <nav aria-label="Page navigation">
                                <ul class="pagination pagination-lg justify-content-center bg-white mb-0" style="padding: 30px;">
                                  <li class="page-item ">
                                    <a class="page-link" href="comunicadosC.php?pag=<?php echo($pag -1)?>" aria-label="Previous">
                                  ...
                                  <?php
                                  if ($pag > 1) {
                                        echo "<li class='page-item' ><a class='page-link' href='comunicadosC.php?pag=" . ($pag - 1) . "'>" . ($pag - 1) . "</a></li>";
                                    }  
                                    
                                    

                                    echo "<li class='page-item active'><a class='page-link' href='comunicadosC.php?pag=" . ($pag). "'>".$pag."</a></li>";
                                    if ($pag < $totalPaginas) {
                                    echo "<li class='page-item '><a class='page-link' href='comunicadosC.php?pag=" . ($pag + 1). "'>".($pag +1)."</a></li>";
                                    }
                                    if ($pag +1 < $totalPaginas) {
                                        echo "<li class='page-item'><a class='page-link' href='comunicadosC.php?pag=" . ($totalPaginas) . "'>" . ($totalPaginas) . "</a></li>";
                                    }
                                    ?>
                                  <li class="page-item" >
                                    <a class="page-link" href="comunicadosC.php?pag=<?php echo($pag +1)?>" aria-label="Next">
