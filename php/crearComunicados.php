...
$consulta = "SELECT correo, tipo, nombre, apellido, telefono, imagen, dni, modalidad FROM usuario WHERE correo = '".$usuario."'";
...
if ($_POST) {
    ...
    $objConexion = new Conexion();
    $sqlComunicado = "INSERT INTO `comunicados` (`titulo`, `comunicado`, `imagenC`, `id_alumno`, `id_curso`, `fecha`, `id_res`) VALUES ('$titulo', '$comunicado', '$imagen','$alumno', '$curso', '$date', '$id_res')";
    $objConexion->ejecutar($sqlComunicado);
    
    header("Location: crearComunicados.php");
    exit;
...
$objConexion = new Conexion();
$Comunicados = $objConexion->consultar("SELECT * FROM `comunicados`");
    ...
    <div class="container-fluid page-header" style="background-color: green">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">Crear Comunicado</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="inicio.php">Inicio</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Crear Comunicado</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <?php 
                        ...
                        $comunicadosC = "SELECT * FROM comunicados";
                           ...
                           foreach ($ComunicadoC as $comunicadosC){ 
                            ...
                            if ($contador < $startIndex) {
                                ...
                                $imagenRuta = 'imagenes/';
                                $imagen = $imagenRuta . $comunicadosC['imagenC'];
                           ...
                           <form action="comunicadosC.php" enctype = "multipart/form-data" method="post">
                           <div class="blog-item">
                               
                               <div class="position-relative">
                                   <img class="img-fluid w-65" src="<?php echo $imagen;?>" alt="">
                                   <div class="blog-date">
                                       <small class="mb-n3 font-weight-bold">Fecha: <?php echo $comunicadosC['fecha'] ?></small>
                                       <small class="mb-n3 font-weight-bold">Curso: <?php echo $comunicadosC['id_curso'] ?></small>
                                       <small class="mb-n3 font-weight-bold">Alumno: <?php echo $comunicadosC['id_alumno'] ?></small>
                               ...
                               <div class="bg-white p-4">
                                   <div class="d-flex mb-2">
                                       ...
                                       <a class="text-primary text-uppercase text-decoration-none" href="mostrarComunicado.php?id=<?php echo urlencode($comunicadosC['codigo']);?>"><?php echo $comunicadosC['titulo'];?></a>
                                   </div>
                                   <a class="h5 m-0 text-decoration-none" href="mostrarComunicado.php?id=<?php echo urlencode ($comunicadosC['codigo']);?>"><?php
                                   ...
                                   <a class="btn btn-danger" href="?borrar=<?php echo $comunicadosC['codigo'];?>">Eliminar</a>
                    ...
                    $sqlTotalComunicados = "SELECT COUNT(*) AS total FROM comunicados";
                       ...
                       <div class="col-12">
                            <nav aria-label="Page navigation">
                                <ul class="pagination pagination-lg justify-content-center bg-white mb-0" style="padding: 30px;">
                                  <li class="page-item ">
                                    <a class="page-link" href="crearComunicados.php?pag=<?php echo($pag -1)?>" aria-label="Previous">
                                  ...
                                  <?php
                                  if ($pag > 1) {
                                        echo "<li class='page-item' ><a class='page-link' href='crearComunicados.php?pag=" . ($pag - 1) . "'>" . ($pag - 1) . "</a></li>";
                                    }  
                                    
                                    

                                    echo "<li class='page-item active'><a class='page-link' href='crearComunicados.php?pag=" . ($pag). "'>".$pag."</a></li>";
                                    if ($pag < $totalPaginas) {
                                    echo "<li class='page-item '><a class='page-link' href='crearComunicados.php?pag=" . ($pag + 1). "'>".($pag +1)."</a></li>";
                                    }
                                    if ($pag +1 < $totalPaginas) {
                                        echo "<li class='page-item'><a class='page-link' href='crearComunicados.php?pag=" . ($totalPaginas) . "'>" . ($totalPaginas) . "</a></li>";
                                    }
                                    ?>
                                  <li class="page-item" >
                                    <a class="page-link" href="crearComunicados.php?pag=<?php echo($pag +1)?>" aria-label="Next">
                ...
                <div class="container">
                    ...
                    <div class="card-body">
                    <form action="crearComunicados.php" method="post" enctype = "multipart/form-data">
                
                        Nombre del comunicado: <input required class="form-control" type="text" method="post" name="titulo">
                
                    <br>
                        Comunicado: <textarea type="text" method="post" name="comunicado" id="" cols="17" rows="3"></textarea>
                
                    <br>
                        Alumno: <input  class="form-control" type="text" method="post" name="alumno">
                
                    <br>
                        Curso: <input class="form-control" type="text" method="post" name="curso">
                
                    <br>
                        Fecha: <input required class="form-control" type="date" method="post" name="fecha">
...
if($_GET){
    ...
    $imagen= $objConexion->consultar("SELECT imagenC FROM `comunicados` WHERE codigo=".$id);

    unlink("imagenes/".$imagen[0]['imagen'] );
    
    $sql = "DELETE FROM `comunicados` WHERE `codigo` =".$id ;
