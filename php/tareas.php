            ...
            <div class="row">
                <div class="col-lg-6 text-center text-lg-left mb-2 mb-lg-0">
                    ...
                    <p><i class="fa fa-envelope mr-2"></i>virtualiateamwork@gmail.com</p>
                        ...
                        <p><i class="fa fa-phone-alt mr-2"></i>+54 9 11 3119-2288</p></div>
                </div>
        ...
        <div class="container py-5">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <?php 
                         ...
                         $startIndex = ($pag - 1) * 4;
                          $endIndex = $startIndex + 3;
                            ...
                            $trabajos = "SELECT * FROM trabajos JOIN usuario ON trabajos.id_curso = usuario.id_curso WHERE usuario.dni = '".$dni."';";
                           ...
                           <form action="tareas.php" enctype = "multipart/form-data" method="post">
                           <div class="blog-item">
                               ...
                               <div class="bg-white p-4">
                                   ...
                                   <a class="h5 m-0 text-decoration-none" href="mostrarTarea.php?id=<?php echo urlencode ($trabajos['id']);?>"><?php 
                    ...
                    $sqlTotalComunicados = "SELECT COUNT(*) AS total FROM trabajos WHERE id_curso = $curso";
